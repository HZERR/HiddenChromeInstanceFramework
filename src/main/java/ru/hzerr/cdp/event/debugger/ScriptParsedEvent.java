...
import ru.hzerr.cdp.type.debugger.DebugSymbols;
import ru.hzerr.cdp.type.debugger.ResolvedBreakpoint;
...
public class ScriptParsedEvent {
	...
	private List<DebugSymbols> debugSymbols;
	...
	@Experimental
	@Description("The list of set breakpoints in this script if calls to `setBreakpointByUrl` matches this script's URL or hash. Clients that use this list can ignore the `breakpointResolved` event. They are equivalent.")
	private List<ResolvedBreakpoint> resolvedBreakpoints;
	...
	public List<ResolvedBreakpoint> getResolvedBreakpoints() {
		return this.resolvedBreakpoints;
	}
